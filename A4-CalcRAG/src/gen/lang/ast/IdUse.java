...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/calc.ast:9
...
public class IdUse extends Expr implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/PrettyPrint.jrag:31
   */
...
protected boolean decl_visited = false;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:2
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:2")
  public IdDecl decl() {
...
protected boolean isCircular_visited = false;
   ...
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:32
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="CircularDefinitions", declaredAt="/h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:32")
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:3
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:3")
...
protected java.util.Set lookup_String_visited;
   ...
   * @attribute inh
   * @aspect CircularDefinitions
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:33
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="CircularDefinitions", declaredAt="/h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:33")
...
protected java.util.Set inExprOf_IdDecl_visited;
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/Errors.jrag:34
    if (decl().isUnknown()) {
      {
    ...
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/Errors.jrag:42
    if (isCircular()) {
      {
        Program target = (Program) (program());
        java.util.Set<ASTNode> contributors = _map.get(target);
