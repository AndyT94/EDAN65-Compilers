...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/calc.ast:7
...
public class IdDecl extends Expr implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/PrettyPrint.jrag:35
   */
...
protected boolean isMultiplyDeclared_visited = false;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:27
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:27")
...
protected boolean isUnknown_visited = false;
   ...
   * @attribute syn
   * @aspect UnknownDecl
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/UnknownDecl.jrag:7
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="UnknownDecl", declaredAt="/h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/UnknownDecl.jrag:7")
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:26
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/NameAnalysis.jrag:26")
...
protected java.util.Set lookup_String_visited;
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A4-CalcRAG/src/jastadd/Errors.jrag:38
