...
/**
 * @ast node
 * @declaredat /h/d1/t/dat13aol/edan65/MinimalAST/src/jastadd/lang.ast:11
 * @production NumeralExpr : {@link Expr} ::= <span class="component">&lt;NUMERAL:String&gt;</span>;

 */
public class NumeralExpr extends Expr implements Cloneable {
  /**
   ...
   */
  public NumeralExpr(String p0) {
    setNUMERAL(p0);
  }
  /**
   * @declaredat ASTNode:15
   */
  public NumeralExpr(beaver.Symbol p0) {
    setNUMERAL(p0);
  }
  /** @apilevel low-level 
   ...
   */
  public NumeralExpr clone() throws CloneNotSupportedException {
    NumeralExpr node = (NumeralExpr) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:36
   */
  public NumeralExpr copy() {
    try {
      NumeralExpr node = (NumeralExpr) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public NumeralExpr treeCopyNoTransform() {
    NumeralExpr tree = (NumeralExpr) copy();
    if (children != null) {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenString_NUMERAL == ((NumeralExpr) node).tokenString_NUMERAL);    
  }
  /**
