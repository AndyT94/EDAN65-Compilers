...
/**
 * @ast node
 * @declaredat /h/d1/t/dat13aol/edan65/A1-CalcParse/MinimalAST/src/jastadd/lang.ast:21
 * @production Exprs : {@link ASTNode} ::= <span class="component">{@link Expr}*</span>;

 */
public class Exprs extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/t/dat13aol/edan65/A1-CalcParse/MinimalAST/src/jastadd/PrettyPrint.jrag:178
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /h/d1/t/dat13aol/edan65/A1-CalcParse/MinimalAST/src/jastadd/Visitor.jrag:40
   */
   ...
   */
  public Exprs clone() throws CloneNotSupportedException {
    Exprs node = (Exprs) super.clone();
    return node;
  }
  /** @apilevel internal 
   ...
   */
  public Exprs treeCopyNoTransform() {
    Exprs tree = (Exprs) copy();
    if (children != null) {
