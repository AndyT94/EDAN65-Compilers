...
/**
 * @ast node
 * @declaredat /h/d1/t/dat13aol/edan65/MinimalAST/src/jastadd/lang.ast:7
 * @production Assignment : {@link Stmt} ::= <span class="component">{@link Id_decl}</span> <span class="component">{@link Expr}</span>;
...
public class Assignment extends Stmt implements Cloneable {
   ...
   */
  public Assignment(Id_decl p0, Expr p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
