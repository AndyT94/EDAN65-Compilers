 ...
 * @production Function_Call : {@link Stmt} ::= <span class="component">{@link Id_decl}</span> <span class="component">{@link Expr}*</span>;

 */
public class Function_Call extends Stmt implements Cloneable {
  /**
   ...
   */
  public Function_Call(Id_decl p0, List<Expr> p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
   ...
   */
  public Function_Call clone() throws CloneNotSupportedException {
    Function_Call node = (Function_Call) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:36
   */
  public Function_Call copy() {
    try {
      Function_Call node = (Function_Call) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public Function_Call treeCopyNoTransform() {
    Function_Call tree = (Function_Call) copy();
    if (children != null) {
