...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/calc.ast:11
...
public class Let extends Expr implements Cloneable {
  /**
   * @aspect CodeGen
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/CodeGen.jrag:147
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/PrettyPrint.jrag:39
   */
...
protected java.util.Set localLookup_String_int_visited;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/NameAnalysis.jrag:12
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/NameAnalysis.jrag:12")
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/NameAnalysis.jrag:10
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/NameAnalysis.jrag:10")
...
protected java.util.Set lookup_String_visited;
  ...
  public IdDecl Define_lookup(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getBindingListNoTransform()) {
      ...
      // @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/NameAnalysis.jrag:5
      {
