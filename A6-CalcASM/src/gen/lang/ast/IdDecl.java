...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/calc.ast:14
...
public class IdDecl extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/PrettyPrint.jrag:35
   */
...
protected boolean address_visited = false;
   ...
   * @attribute syn
   * @aspect CodeGen
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/CodeGen.jrag:171
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="CodeGen", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/CodeGen.jrag:171")
...
protected boolean isMultiplyDeclared_visited = false;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/NameAnalysis.jrag:27
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/NameAnalysis.jrag:27")
...
protected boolean isUnknown_visited = false;
   ...
   * @attribute syn
   * @aspect UnknownDecl
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/UnknownDecl.jrag:7
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="UnknownDecl", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/UnknownDecl.jrag:7")
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/NameAnalysis.jrag:26
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/NameAnalysis.jrag:26")
...
protected java.util.Set lookup_String_visited;
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A6-CalcASM/src/jastadd/Errors.jrag:38
