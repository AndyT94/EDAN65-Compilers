...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/lang.ast:2
...
public class Function extends ASTNode<ASTNode> implements Cloneable, Comparable<Function> {
  /**
   * @aspect CodeGen
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/CodeGen.jrag:100
   */
   ...
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/FunctionCollection.jrag:7
   */
  ...
  /**
   * @aspect Interpreter
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:52
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/PrettyPrint.jrag:15
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Visitor.jrag:52
   */
...
protected ASTNode$State.Cycle reachable_cycle = null;
  ...
  @ASTNodeAnnotation.Source(aspect="Interpreter", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:206")
...
protected java.util.Set localLookup_String_visited;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:56
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:56")
  ...
  @ASTNodeAnnotation.Source(aspect="Interpreter", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:215")
...
protected boolean isCircular_visited = false;
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:45
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:45")
...
protected java.util.Set lookup_String_visited;
  ...
  /**
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:199
   * @apilevel internal
   */
  ...
  public Id_decl Define_lookup(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getParamsNoTransform()) {
      // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:53
      {
      		return localLookup(name);
      	}
    }
    else if (_callerNode == getBlockNoTransform()) {
      // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:49
      {
      ...
      // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:46
      {
      		return lookup(name);
      	}
    }
...
protected boolean Function_functionCollections_visited = false;
  ...
  @ASTNodeAnnotation.Source(aspect="FunctionCollection", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/FunctionCollection.jrag:20")
...
protected boolean Function_stringCollections_visited = false;
   ...
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.COLL)
  @ASTNodeAnnotation.Source(aspect="FunctionCollection", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/FunctionCollection.jrag:21")
  ...
  protected void collect_contributors_Function_stringCollections(Function _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/FunctionCollection.jrag:28
    if (isCircular()) {
      {
