...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/lang.ast:3
...
public class Params extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/PrettyPrint.jrag:25
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Visitor.jrag:49
   */
  ...
  public String Define_address(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getId_declListNoTransform()) {
      // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/CodeGen.jrag:314
      int index = _callerNode.getIndexOfChild(_childNode);
      return (16 + index*8) + "(%rbp)";
    }
    else {
