...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/lang.ast:36
 * @production UnknownDecl : {@link Id_decl};

 */
public class UnknownDecl extends Id_decl implements Cloneable {
  /**
...
protected boolean type_visited = false;
   ...
   * @attribute syn
   * @aspect UnknownDecl
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/UnknownDecl.jrag:10
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="UnknownDecl", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/UnknownDecl.jrag:10")
  public Type type() {
    if (type_visited) {
