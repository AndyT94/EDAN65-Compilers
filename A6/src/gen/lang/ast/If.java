...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/lang.ast:12
...
public class If extends Stmt implements Cloneable {
  /**
   * @aspect CodeGen
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/CodeGen.jrag:140
   */
  ...
  /**
   * @aspect Interpreter
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:91
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/PrettyPrint.jrag:81
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Visitor.jrag:58
   */
...
protected boolean compatibleTypes_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:52
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:52")
  ...
  public Type Define_expectedType(ASTNode _callerNode, ASTNode _childNode) {
    if (_callerNode == getExprNoTransform()) {
      // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:31
      return boolType();
    }
    else {
  ...
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Errors.jrag:58
    if (!compatibleTypes()) {
      {
