...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/lang.ast:35
...
public class Id_decl extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/PrettyPrint.jrag:167
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Visitor.jrag:118
   */
...
protected boolean uniqueName_visited = false;
   ...
   * @attribute syn
   * @aspect Interpreter
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:186
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="Interpreter", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:186")
  public String uniqueName() {
    if (uniqueName_visited) {
      throw new RuntimeException("Circular definition of attribute Id_decl.uniqueName().");
    }
    uniqueName_visited = true;
    String uniqueName_value = index() + getID();
...
protected boolean isMultiplyDeclared_visited = false;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:9
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:9")
...
protected boolean type_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:17
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:17")
  public Type type() {
    if (type_visited) {
...
protected boolean bothVarNFunc_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:66
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:66")
...
protected java.util.Set sameParams_FunctionExpr_visited;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:74
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:74")
...
protected boolean isUnknown_visited = false;
   ...
   * @attribute syn
   * @aspect UnknownDecl
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/UnknownDecl.jrag:7
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="UnknownDecl", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/UnknownDecl.jrag:7")
   ...
   * @attribute inh
   * @aspect CodeGen
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/CodeGen.jrag:312
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="CodeGen", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/CodeGen.jrag:312")
  public String address() {
    if (address_visited) {
      throw new RuntimeException("Circular definition of attribute Id_decl.address().");
    }
    address_visited = true;
    String address_value = getParent().Define_address(this, null);
...
protected boolean address_visited = false;
   ...
   * @attribute inh
   * @aspect Interpreter
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:187
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="Interpreter", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:187")
  public String index() {
    if (index_visited) {
      throw new RuntimeException("Circular definition of attribute Id_decl.index().");
    }
    index_visited = true;
...
protected boolean index_visited = false;
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:8
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:8")
...
protected java.util.Set lookup_String_visited;
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:81
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="NameAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/NameAnalysis.jrag:81")
...
protected java.util.Set functionLookup_String_visited;
   ...
   * @attribute inh
   * @aspect TypeAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:57
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:57")
...
protected boolean isVariable_visited = false;
   ...
   * @attribute inh
   * @aspect TypeAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:58
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:58")
...
protected boolean isFunction_visited = false;
   ...
   * @attribute inh
   * @aspect TypeAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:69
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.INH)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:69")
...
protected boolean function_visited = false;
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Errors.jrag:38
    ...
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Errors.jrag:62
    if (bothVarNFunc()) {
      {
        Program target = (Program) (program());
        java.util.Set<ASTNode> contributors = _map.get(target);
