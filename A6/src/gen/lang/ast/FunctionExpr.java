...
/**
 * @ast node
 * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/lang.ast:20
...
public class FunctionExpr extends Expr implements Cloneable {
  /**
   * @aspect CodeGen
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/CodeGen.jrag:172
   */
  ...
  /**
   * @aspect Interpreter
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:124
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/PrettyPrint.jrag:171
   */
  ...
  /**
   * @aspect Visitor
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Visitor.jrag:43
   */
...
protected boolean hasAllParam_visited = false;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:72
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="TypeAnalysis", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/TypeAnalysis.jrag:72")
  ...
  @ASTNodeAnnotation.Source(aspect="Interpreter", declaredAt="/h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Interpreter.jrag:199")
  public Function enclosedFunction() {
    if (enclosedFunction_visited) {
      throw new RuntimeException("Circular definition of attribute FunctionExpr.enclosedFunction().");
    }
...
protected boolean enclosedFunction_visited = false;
  protected void collect_contributors_Program_errors(Program _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/Errors.jrag:66
    if (!hasAllParam()) {
      {
  ...
  protected void collect_contributors_Function_functionCollections(Function _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /h/d1/l/dat13at1/git/Edan65/A6/src/jastadd/FunctionCollection.jrag:25
    {
      Function target = (Function) (enclosedFunction());
      java.util.Set<ASTNode> contributors = _map.get(target);
      if (contributors == null) {
        contributors = new java.util.LinkedHashSet<ASTNode>();
        _map.put((ASTNode) target, contributors);
    ...
    super.collect_contributors_Function_functionCollections(_root, _map);
  }
  ...
  protected void contributeTo_Function_functionCollections(Set<Function> collection) {
    super.contributeTo_Function_functionCollections(collection);
    collection.add(functionCollection(getId_use().decl().functionLookup(getId_use().getID()).function()));
  }
}
